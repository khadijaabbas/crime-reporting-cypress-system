...
## Setup Instructions
Download XAMPP then run MySqlDatabase and Apache Web Server.
Clone the GitHub repo and place it inside htdocs in the XAMPP folder.
Open the link: "http://localhost/crime-reporting-cypress-system-main/index.html"
